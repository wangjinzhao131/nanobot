...
class ChannelManager:
    ...
    async def _send_once(channel: BaseChannel, msg: OutboundMessage) -> None:
        ...
        if msg.metadata.get("_stream_delta") or msg.metadata.get("_stream_end"):
        ...
        elif msg.metadata.get("_pin"):
            action = msg.metadata.get("pin_action", "pin")
            message_id = msg.metadata.get("pin_message_id", "")
            if not message_id:
            ...
            if action == "pin":
                ...
                success = await channel._unpin_message(message_id)
            else:
                logger.warning("Unknown pin action: {}", action)
                return
            if not success:
                logger.warning("Pin {} failed for message {}", action, message_id)
