...
class AgentLoop:
    ...
    def _register_default_tools(self) -> None:
        ...
        self.tools.register(PinTool(pin_callback=self._publish_pin_request))
    ...
    async def _publish_pin_request(
        self, message_id: str, action: str, channel: str, chat_id: str
    ) -> bool:
        """Publish a pin/unpin request to the message bus."""
        msg = OutboundMessage(
            channel=channel,
            chat_id=chat_id,
            content="",
    ...
    def _set_tool_context(self, channel: str, chat_id: str, message_id: str | None = None) -> None:
        ...
        for name in ("message", "spawn", "cron", "pin"):
